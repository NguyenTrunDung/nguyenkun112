        ...
        <%
              if (session.getAttribute("login") == null) {
                    ...
                    if (session.getAttribute("login").equals("staff")) {
                          ...
                          String fullname = acc.getAccountName();
                          String staff_id = acc.getAccountID() + "";
        %>
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="/profile?staff=<%= acc.getAccountID()%>">Profile</a></li>
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <%
                                      ResultSet rs = aO.getAllOrdersByStaff(acc.getAccountEmail());
                                      int count = 0;
                                      double a;
                                      if (rs != null) {
                                            while (rs.next()) {
                                                  count++;
                                                   a = Double.valueOf(rs.getDouble("total_price"));
